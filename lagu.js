...
/*    {
    ...
    },*/
    {
        ...
        lyrics: [
            { time: 0  ,  text: "And,now,I'm stadin here hoping it gets to you" },
            { time: 4  ,  text: "Cause you could be the one that I love" },
            { time: 8,  text: "I could be the one that you dream of " },
            { time: 13, text: "A message in a bottle is all I can do" },
            { time: 16, text: "Standin' here, hopin' it gets to you" },
...
/*    {
    ...
    // },
    {
        ...
        album: "÷ (Divide)",
        albumArtUrl: "https://images.unsplash.com/photo-1519681393784-d120267933ba?w=300&h=300&fit=crop",
        audioSrc: "audio/bergema.mp3",
        videoBgSrc: "videos/bergema.mp4", // Path video background khusus lagu ini
        // Lirik dengan timestamp dalam detik
        lyrics: [
            { time: 0 , text: "Dunia pasti ada akhirnya" },
            { time: 5, text: "Bintang-bintang pun ada umurnya" },
            { time: 11, text: "Maka tenang saja kita disini berduaaaaa" },
            { time: 20, text: "Nikmati sementara yang adaaaaa" },
            { time: 23, text: "Dunia pasti ada akhirnyaa" },
            { time: 30, text: "Bintang-biintang pun ada umurnya" },
            { time: 35, text: "Maka tenang saja kita disini berduaaaa" },
            { time: 44, text: "Nikmati sementaraa yang adaaa" },
            { time: 50, text: "Semoga bahagia selamanyaaaaa" },
